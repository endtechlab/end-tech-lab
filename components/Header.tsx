        ...
        <div className="flex items-center justify-between w-full md:w-auto">
          ...
          >
            <div className="w-6 h-6 flex flex-col justify-center items-center relative">
              <span className={`w-4 h-0.5 bg-white transition-all duration-300 origin-center ${isMenuOpen ? 'rotate-45' : ''}`}></span>
              <span className={`w-6 h-0.5 bg-white mt-1 transition-all duration-300 origin-center ${isMenuOpen ? 'opacity-0' : ''}`}></span>
              <span className={`w-4 h-0.5 bg-white mt-1 transition-all duration-300 origin-center ${isMenuOpen ? '-rotate-45' : ''}`}></span>
            </div>
          </button>
        </div>
